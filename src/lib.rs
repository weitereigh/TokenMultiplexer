// src/lib.rs
/*
 * Core library for TokenMultiplexer
 */
...
#[derive(Debug)]
pub struct TokenMultiplexerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenMultiplexerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenMultiplexer processing");
    
    let mut processor = TokenMultiplexerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenMultiplexerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenMultiplexerProcessor::new(false);
